...
{.Name="SensorDataTask",   .Func=SensorDataTask,    .State=OS_READY,    .TimeDelay=1000*0.25,   .TimeUsedLeast=0xFFFFFFFF},
{.Name="ImuUpdateTask",   .Func=ImuUpdateTask,    .State=OS_READY,    .TimeDelay=1000,   .TimeUsedLeast=0xFFFFFFFF},
{.Name="CommunicateTask",   .Func=CommunicateTask,    .State=OS_READY,    .TimeDelay=1000,   .TimeUsedLeast=0xFFFFFFFF},
{.Name="MotorTask",   .Func=MotorTask,    .State=OS_READY,    .TimeDelay=1000,   .TimeUsedLeast=0xFFFFFFFF},
